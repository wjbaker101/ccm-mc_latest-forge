...
public final class EditCrosshairGuiScreen extends GuiScreen {
    ...
    private void buildComponents() {
        var generalSettingsPanel = new GeneralSettingsGuiPanel(this, -1, -1, this.panelWidth, -1);
        var shapeSettingsPanel = new ShapeSettingsGuiPanel(this, -1, -1, this.panelWidth, -1);
        var visibilitySettingsPanel = new VisibilitySettingsGuiPanel(this, -1, -1, this.panelWidth, -1);
        var outlineSettingsPanel = new OutlineSettingsGuiPanel(this, -1, -1, this.panelWidth, -1);
        var dotSettingsPanel = new DotSettingsGuiPanel(this, -1, -1, this.panelWidth, -1);
        var dynamicSettingsPanel = new DynamicSettingsGuiPanel(this, -1, -1, this.panelWidth, -1);
